...
##### Unload and load ssh
alias rssh='sudo launchctl diable /System/Library/LaunchDaemons/ssh.plist && sudo launchctl enable -w /System/Library/LaunchDaemons/ssh.plist && echo "reloaded ssh"'
